...
print("----------------------------Importing_the_combined_csv_file----------------------------")
print()
cleaned_file = pd.read_csv('31006190202239-Library-task2_cleaned_data.csv')
cleaned_file
print()
print()
print("_____________________________________________________________________TASK3_____________________________________________________________________")
print()
print()
members_per_neighborhoods = cleaned_file.groupby('neighborhood')['member_id'].count().reset_index(name = 'members_count')
checkouts_per_neighborhoods = cleaned_file.groupby('neighborhood')['checkout_id'].count().reset_index(name = 'checkouts_count')
neighborhood_comparsion = pd.merge(members_per_neighborhoods , checkouts_per_neighborhoods , on = 'neighborhood' )
print(neighborhood_comparsion)
